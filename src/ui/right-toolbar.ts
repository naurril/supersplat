...
class RightToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const labelPanelBtn = new Button({
            id: 'right-toolbar-label-panel',
            class: 'right-toolbar-toggle',
            icon: 'E164'
        });
        ...
        tooltips.register(labelPanelBtn, tooltip('tooltip.right-toolbar.labels'), 'left');
        ...
        labelPanelBtn.on('click', () => events.fire('labelPanel.toggleVisible'));
        ...
        events.on('labelPanel.visible', (visible: boolean) => {
            labelPanelBtn.class[visible ? 'add' : 'remove']('active');
        });
